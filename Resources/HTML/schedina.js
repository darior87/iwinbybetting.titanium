$.getJSON('http://api.iwinbybetting.ofunwebservices.com/schedina/'+getParameterByName("rischio"), function(data) {
	...
	content += "</ul>";
    document.getElementById('schedina').innerHTML = content;
