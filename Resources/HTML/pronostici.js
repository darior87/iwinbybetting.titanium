$.getJSON('http://api.iwinbybetting.ofunwebservices.com/pronostici/get/'+getParameterByName("id"), function(data) {
	...
	content += "</ul>";
    document.getElementById('pronostici').innerHTML = content;
